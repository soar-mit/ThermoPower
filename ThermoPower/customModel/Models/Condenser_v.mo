...
model Condenser_v "Condenser"
  extends ThermoPower.PowerPlants.SteamTurbineGroup.Interfaces.Condenser;
  ...
  Water.Flow1D flowCooling(
    ...
    dpnom=dpnom_cool,
    rhonom=rhonom_cool,
    HydraulicCapacitance=HCtype_cool) annotation (Placement(
        transformation(
        origin={20,10},
        extent={{-12,-10},{12,10}},
        rotation=90)));
